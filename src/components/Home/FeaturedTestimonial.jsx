...
const FeaturedTestimonial = () => {
  ...
  return (
    <div className="mb-[30px]">
      ...
      <div className="grid grid-rows-2 p-[30px] rounded-lg bg-white gap-5">
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <h4 className="text-sm font-medium text-[#232F3C]">
                {testimonial.name}{" "}
                <span className="text-[#156BCA] italic font-bold">by Cork</span>{" "}
              </h4>
      ...
      <div className="flex justify-center mt-6 text-[#3B463373]">
