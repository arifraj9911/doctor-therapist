...
import ResponsiveRegister from "../../ResponsiveRegister/ResponsiveRegister";
  ...
  return (
    <div>
      <div className="md:hidden">
        <ResponsiveRegister></ResponsiveRegister>
      </div>
        ...
        <div className="flex justify-between gap-20 p-20">
          ...
          <div className="w-5/6 relative">
            ...
            <p className="w-1/3 bg-black text-center text-white p-5 rounded-lg absolute top-72 left-52 opacity-70 text-[16px]">
              <span className="text-[#156BCA] ">Create Account</span> <br />{" "}
